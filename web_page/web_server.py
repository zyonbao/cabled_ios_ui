...
This module lives alongside (not inside) the ios_toolkit package and reuses its
capability layer (ios_toolkit.toolkit_api).

Run from the repository root:
    python3 -m web_page.web_server            # http://127.0.0.1:8787
...
app = FastAPI(title="ios_toolkit web UI", docs_url=None, redoc_url=None)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ios_toolkit interactive web UI")
    ...
    print(f"ios_toolkit web UI → http://{args.host}:{args.port}")
